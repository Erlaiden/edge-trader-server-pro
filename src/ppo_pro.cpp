                  ...
                  bool /*use_antimanip*/)
{
    ...
    try{
        ...
        // -------- Reward v2 @best_thr --------
        etai::rv2::init_from_env(); // без побочек
        double fee  = etai::rv2::get_fee_per_trade();
        double a_sh = etai::rv2::get_alpha_sharpe();
        double lam  = etai::rv2::get_lambda_risk();
        double mu_m = etai::rv2::get_mu_manip();

        double manip_penalty_avg = 0.0; // подключим позже
        ...
        etai::rv2::set_reward_avg(reward_v2);
        etai::rv2::set_reward_sharpe(sharpe);
        etai::rv2::set_reward_winrate(winrate);
        etai::rv2::set_reward_drawdown(dd_max);
