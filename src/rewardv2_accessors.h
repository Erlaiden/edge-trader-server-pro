...
double get_val_manip_ratio();
void   set_val_manip_ratio(double v);     // ожидается нормализованная доля [0..1], но не ограничиваем жёстко
double get_val_manip_flagged();           // количество флагов на валидации (как double для Prometheus совместимости)
